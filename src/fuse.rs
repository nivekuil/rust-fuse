...
pub struct fuse_attr {
    ...
    pub ctime: u64,
    #[cfg(target_os = "macos")]
    pub crtime: u64,            // OS X only
    pub atimensec: u32,
    pub mtimensec: u32,
    pub ctimensec: u32,
    #[cfg(target_os = "macos")]
    pub crtimensec: u32,        // OS X only
    pub mode: u32,
    pub nlink: u32,
    pub uid: u32,
    pub gid: u32,
...
pub struct fuse_setattr_in {
    ...
    pub unused5: u32,
    #[cfg(target_os = "macos")]
    pub bkuptime: u64,          // OS X only
    #[cfg(target_os = "macos")]
    pub chgtime: u64,           // OS X only
    #[cfg(target_os = "macos")]
    pub crtime: u64,            // OS X only
    #[cfg(target_os = "macos")]
    pub bkuptimensec: u32,      // OS X only
    #[cfg(target_os = "macos")]
    pub chgtimensec: u32,       // OS X only
    #[cfg(target_os = "macos")]
    pub crtimensec: u32,        // OS X only
    #[cfg(target_os = "macos")]
